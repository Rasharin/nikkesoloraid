        ...
        <div className="order-2 space-y-2 lg:order-1">
          <div className="mb-2 flex justify-end">
            <button
              ...
              className="rounded-2xl border border-red-500/40 bg-red-500/10 px-4 py-2 text-sm text-[var(--theme-text)] transition hover:border-red-400 hover:bg-red-500/15 active:scale-[0.99]"
            >
              전체 해제
            </button>
          </div>
          ...
          <section className="mt-2 rounded-2xl border border-neutral-800 bg-neutral-900/40 p-3">
            <div className="grid gap-2.5">
              ...
              <button
                ...
                className="mt-1 rounded-2xl border border-red-500/40 bg-red-500/10 px-4 py-2 text-sm text-[var(--theme-text)] transition hover:border-red-400 hover:bg-red-500/15 active:scale-[0.99]"
              >
                필터 초기화
              </button>
            </div>
